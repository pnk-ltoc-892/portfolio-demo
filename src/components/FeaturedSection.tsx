    ...
    return (
        <div className='py-12 bg-gray-900'>
                                ...
                                <BackgroundGradient
                                    ...
                                    <div className="p-2 sm:p-6 flex flex-col items-center text-center flex-grow">
                                        ...
                                        <Link href={`/courses/${course.slug}`}
                                            className='p-2 text-sm rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-teal-500 hover:text-white transition-all duration-300'
                                        >
                                            Learn More
                                        </Link>
                                    </div>
            ...
            <div className='mt-20 text-center'>
                <Link href={'/courses'}
                    className='px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-teal-500 hover:text-white transition-all duration-300'
                >
                    View All Courses
                </Link>
            </div>
